...
if IS_MOBILE then
    ...
    -- Des button removed (desync not supported on Delta)
...
--[[ DESYNC PANEL REMOVED FOR DELTA COMPATIBILITY
task.spawn(function()
    -- ============================================================
            ...
            for _, row in ipairs(sList:GetChildren()) do
                ...
                if lbl and lbl.Text == "Subspace Mine Esp" then
                    ...
                    if toggleSwitch then
                        ...
                        if btn then
                            getgenv().subspaceMineESPToggleRef = subspaceMineESPToggleRef; shared.subspaceMineESPToggleRef = subspaceMineESPToggleRef
                        end
                    end
                    break 
                end
...
function buildHeroSettingsUI()
    ...
    -- Desync Visualizer toggle removed
...
-- DESYNC VISUALIZER REMOVED FOR DELTA COMPATIBILITY