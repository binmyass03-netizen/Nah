(function()
-- Delta compatibility shims
local isexecutorclosure = typeof(isexecutorclosure)=="function" and isexecutorclosure or function() return false end
local newcclosure = typeof(newcclosure)=="function" and newcclosure or function(f) return f end
local getconnections = typeof(getconnections)=="function" and getconnections or function() return {} end
local firesignal = typeof(firesignal)=="function" and firesignal or function() end
local cloneref = typeof(cloneref)=="function" and cloneref or function(s) return s end
local readfile = typeof(readfile)=="function" and readfile or function() return nil end
local writefile = typeof(writefile)=="function" and writefile or function() end
...
-- Helper: throttle de conexes para evitar limite de 200 upvalues/conexes
        ...
        blBtn.MouseButton1Click:Connect(function()
            pcall(function()
                if isBlacklisted(plr.Name) then
                    ...
                    ShowNotification("BLACKLIST", "v Removed: " .. plr.Name)
                else
...
task.spawn(function()
    ...
    -- Boto de tema desativado - substituido pela nova UI
        ...
        for i, name in ipairs(BlacklistedPlayers) do
            ...
            remBtn.MouseButton1Click:Connect(function()
                pcall(function()
                    ...
                    ShowNotification("BLACKLIST", "v Removed: " .. n)
                    refreshBlacklistUI()
                end)
            end)
        end
...
function buildMiniActionsUI()
    ...
    local function toggleAutoBuy()
        ...
        ShowNotification("AUTO BUY", autoBuyActive and "v ATIVADO" or "x DESATIVADO")
    end
